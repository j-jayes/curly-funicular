...
// Use runtime environment variable (injected via window.env) or fallback to build-time or localhost
const API_BASE_URL = window.env?.REACT_APP_API_URL || process.env.REACT_APP_API_URL || 'http://localhost:8000/api/v1';
